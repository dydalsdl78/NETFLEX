<template>
  <div id="app">
    <nav class="navbar navbar-expand-lg sticky-top mb-5" style="color:white; background-color:transparent;">
      <router-link class="navbar-brand" :to="{ name: 'Home' }"
        >  <img src="./assets/ssaflix(white).png" height="40" class="d-inline-block align-top" alt="">  </router-link
      >
      <button
